          ...
          <div className="px-4 py-16 bg-gray-50 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            <div className="max-w-[700px] mx-auto">
              ...
              <p className="mt-3 text-lg leading-6 text-gray-500">
                Need to bounce off ideas for an upcoming project or digital
                campaign? Looking to transform your business with the
                implementation of full potential digital marketing?
              </p>
              <p className="mt-3 text-lg leading-6 text-gray-500">
                Whether it’s a quick brainstorm session, free consultation, or
                comprehensive digital audit, our talented team of digital
                experts is here and ready to help you reach your business goals,
                faster. So drop us a line today and let’s get to work!
              </p>
              <dl className="mt-8 text-base text-gray-500">
                <div>
                  <dt className="sr-only">Postal address</dt>
                  <dd>
                    <p>New Delhi, IN 110062</p>
                  </dd>
                </div>
                <div className="mt-6">
                ...
                <div className="mt-3">
                  ...
                  <dd className="flex">
                    ...
                    />
                    <a
                      href="mailto:talk@veroxyle.com?subject=ref:site"
                      className="ml-3"
                    >
                      talk@veroxyle.com
                    </a>
